...
function palettify () {
  ...
  function __addBoxShadowToElementData (colors, obj) {
    ...
    obj.hoverTarget.dataset['boxShadow'] = boxShadow;
  }
    ...
    self = {
      ...
      enterHandler: function enterHandler (event) {
        ...
        if (target) {
          ...
          target.style.boxShadow = event.currentTarget.dataset.boxShadow;
        }
      },
      /**
       ...
       * @param event
       */
      leaveHandler: function leaveHandler (event) {
        var target = event.currentTarget.querySelector(self.options.attachBoxShadowTo || self.options.imageTarget);
        if (target) {
      ...
      attachEventListeners: function attachEventListeners () {
        ...
        self.elements.forEach(function (obj) {
          obj.hoverTarget.addEventListener(enterEvent, self.enterHandler, false);
          obj.hoverTarget.addEventListener(leaveEvent, self.leaveHandler, false);
        });
      },
      /**
      ...
      detachEventListeners: function detachEventListeners () {
        ...
        var leaveEvent = ref.leaveEvent;
        self.elements.forEach(function (obj) {
          obj.hoverTarget.removeEventListener(enterEvent, self.enterHandler, false);
          obj.hoverTarget.removeEventListener(leaveEvent, self.leaveHandler, false);
        });
      },
      /**
